...
Finished: No
Source: https://nodejs.org/en/blog/announcements/v18-release-announce/
Tags: #nodejs
...
You can read more about our release policy at [https://github.com/nodejs/release](https://github.com/nodejs/release).

To download Node.js 18.0.0, visit: [https://nodejs.org/en/download/current/](https://nodejs.org/en/download/current/). You can find the release post at [https://nodejs.org/en/blog/release/v18.0.0](https://nodejs.org/en/blog/release/v18.0.0), which contains the full list of commits included in this release.
...
- `Blob` - [https://nodejs.org/api/buffer.html#class-blob](https://nodejs.org/api/buffer.html#class-blob)
- `BroadcastChannel` - [https://nodejs.org/api/worker_threads.html#class-broadcastchannel-extends-eventtarget](https://nodejs.org/api/worker_threads.html#class-broadcastchannel-extends-eventtarget)
...
Read more at [https://nodejs.org/dist/latest-v18.x/docs/api/test.html](https://nodejs.org/dist/latest-v18.x/docs/api/test.html).
