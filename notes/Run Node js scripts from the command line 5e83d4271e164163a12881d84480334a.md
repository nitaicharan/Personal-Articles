...
Created: August 16, 2022 6:19 PM
Finished: Yes
Finished 📅: August 16, 2022
Order: 6
Source: https://nodejs.dev/en/learn/run-nodejs-scripts-from-the-command-line
Tags: #nodejs
...
### **[Restart the application automatically](https://nodejs.dev/en/learn/run-nodejs-scripts-from-the-command-line#restart-the-application-automatically)**
