...
Created: August 30, 2022 9:58 AM
Finished: Yes
...
## **[State management](https://nodejs.dev/en/learn/asynchronous-flow-control/#state-management)**
...
## **[Control flow](https://nodejs.dev/en/learn/asynchronous-flow-control/#control-flow)**
...
1. *Limited parallel*: parallel with limit, such as successfully emailing 1,000,000 recipients from a list of 10E7 users.
