...
Aphrodite was built with React in mind but does not depend on React. Here, you can see it used with [Web Components](http://w3c.github.io/webcomponents/spec/custom):
